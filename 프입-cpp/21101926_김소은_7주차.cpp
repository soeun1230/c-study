...
public:
	...
	const Money percent(int percentFigure) const {
		double dollarPercent = dollars * percentFigure / 100.0 + cents * percentFigure / 10000.0;
...
{
	int percentage;
	Money yourAmount, myAmount(100, 9);
	cout << "Enter an amount of money: ";
	cin >> yourAmount;
	cout << "Enter a percent you wish to take of yout amount\n";
	cin >> percentage;
	cout << "Your amount is " << yourAmount << endl;
	cout << "My amount is " << myAmount << endl;
	cout << percentage << "% of your amount is " << yourAmount.percent(percentage) << endl;
	...
	cout << "Yout amount is " << yourAmount << endl;
	cout << "My amount is " << myAmount << endl;
	if (yourAmount >= myAmount) {
		cout << "Your amount is greater than or equal to my Amount" << endl;
	}
	else
		cout << "Your amount is smaller than my Amount" << endl;
	if (ourAmount > diffAmount) {
		cout << "The sum of our Amounts is greater than the difference" << endl;
	}
	else
		cout << "The sum of our Amounts is smaller than or equal to the difference" << endl;
	if (yourAmount > myAmount) {
		cout << "Your amount is greater than my Amount" << endl;
	}
	else
		cout << "Your amount is smaller than or equal to my Amount" << endl;
	if (ourAmount > diffAmount) {
		cout << "The sum of our Amounts is greater than the difference" << endl;
	}
	else
